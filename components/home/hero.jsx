export const Hero = () => {
  ...
  return <div className="text-center mb-10 space-y-4 max-w-2xl mx-auto animate-fade-in-up">
    ...
    <p className="text-lg text-slate-500 font-normal">
      Describe your dream trip. We'll handle the logistics, hotels, and hidden
      gems.
    </p>
  </div>
}